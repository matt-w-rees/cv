...
# Profile
I use quantitative methods to improve conservation monitoring, management and decision-making. I specialise in modelling population dynamics and species interactions, focusing on predator ecology and invasive species management. My computational toolkit is largely made up of GIS, structured decision-making tools, spatial capture-recapture, occupancy models and generalised additive models. I'm well-versed in field ecology which motivates me to consider what is feasible on-ground and fits within socio-economic constraints. More broadly, I'm passionate about transparent science which also considers the needs and knowledge of First Nations People. I am currently finishing up my PhD with the [*Quantitative and Applied Ecology group*](https://qaeco.com){target="_blank"} (supervised by Brendan Wintle, Bronwyn Hradksy & Alan Robley) while tackling the occasional, related contracting job.
